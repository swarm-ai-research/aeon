...
# actionlint (rhysd/actionlint — workflow syntax linter)
# The committed binary in .audit-bin/ is the authoritative version; bump both together.
...
# (https://github.com/rhysd/actionlint/releases) and update the binary in .audit-bin/ if not.
```
