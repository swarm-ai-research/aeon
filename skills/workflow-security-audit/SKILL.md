...
# No version pin here — download-actionlint.bash fetches the latest stable.
# When updating .audit-bin/actionlint, run `actionlint --version` and record
# the version in .audit-bin/README.
