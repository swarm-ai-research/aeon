...
# When auditing this skill, verify ACTIONLINT_VERSION matches .audit-bin/actionlint
# (https://github.com/rhysd/actionlint/releases) and bump both if a new version is out.
```
