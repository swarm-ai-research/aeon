...
# (https://github.com/rhysd/actionlint/releases) and bump if a newer release is out.
# Also replace .audit-bin/actionlint (and the tar.gz) when bumping the version pin.
```
