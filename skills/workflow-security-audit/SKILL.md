...
# No version pin here — the committed binary in .audit-bin/ is the authoritative copy.
# See .audit-bin/README.md for the bundled version and update instructions.
