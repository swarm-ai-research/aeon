...
# When auditing this skill, verify the version in .audit-bin/README.md is still on
# the latest stable (https://github.com/rhysd/actionlint/releases) and bump if needed.
