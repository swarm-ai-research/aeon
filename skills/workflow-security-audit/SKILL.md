...
# No version pin here — the install script always fetches latest stable.
# When updating the pre-cached .audit-bin/actionlint binary, record the new
# version in .audit-bin/README.md.
