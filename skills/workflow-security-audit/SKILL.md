...
# When updating .audit-bin/actionlint, record its version as ACTIONLINT_VERSION here
# (https://github.com/rhysd/actionlint/releases) and pass it as an arg to the download script.
