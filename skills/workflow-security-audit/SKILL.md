...
```bash
# .audit-bin ships both zizmor and actionlint as committed binaries; prepend it so
# the command-v checks below find them before falling back to network installs.
