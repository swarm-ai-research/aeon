...
```bash
# Pre-committed binaries in .audit-bin/ take priority — they bypass the sandbox
# download restrictions that block curl-pipe installs and pip under Claude Code.
