...
# Committed binary is v1.7.12 — verify against https://github.com/rhysd/actionlint/releases
# and replace .audit-bin/actionlint + actionlint.tar.gz when a new version ships.
