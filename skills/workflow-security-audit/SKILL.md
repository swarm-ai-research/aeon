...
```bash
# .audit-bin/ holds pre-cached binaries committed to the repo for sandbox reliability.
# Prepend it so the command -v checks below find them before attempting network downloads.
