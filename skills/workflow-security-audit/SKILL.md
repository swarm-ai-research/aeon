...
# When auditing this skill, verify the .audit-bin/actionlint binary is still current
# (https://github.com/rhysd/actionlint/releases) and replace it when a new version ships.
