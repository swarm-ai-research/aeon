...
# Scan a file for all patterns in a named array, appending matches to a named results array.
# Usage: collect_matches <file> <patterns_array_name> <results_array_name>
collect_matches() {
  local file="$1"
  local -n _patterns="$2"
  local -n _results="$3"
