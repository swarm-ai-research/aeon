...
status: superseded
type: lesson
links: [[iss-006-batch-outage-cadence-hypothesis-broken-by-2-day-gap]], [[iss-006-day-n-needs-witness-independent-of-outage]], [[iss-006-pocket-recovery-is-noise]], [[morning-pocket-splits-into-two-de-facto-clusters]], [[planner-silenced-by-its-own-escalation-target]]
---
...
**Superseded 2026-09-02** by [[iss-006-batch-outage-cadence-hypothesis-broken-by-2-day-gap]] — ISS-022 hit 48 hours after ISS-021, not 48 days, so the monthly-clock framing was pattern-matching against three data points. The three earlier gaps (07-14 → 08-03 → 08-31, all near-48d) turned out to be noise clustering; ISS-006 morning outages are irregular bursts, not a monthly cadence. Historical framing below preserved — fix path (per-slot crons for every `aeon.yml` timeslot) still holds, only the cadence predictor is retired.
