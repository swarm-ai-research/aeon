...
- pr-tracker inline email-OR filter holding for 4th day — `Panniantong/Agent-Reach#436` (6d old today, 0 reviews); crosses 7d stale threshold **tomorrow 2026-07-03** → tomorrow's run will notify unless reviewed. Durable SKILL.md patch (AND→OR or drop prefix) still pending per [[pr-tracker-branch-prefix-misses-bot-identity]].
