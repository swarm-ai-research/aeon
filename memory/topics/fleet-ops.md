...
## Open incidents
- [[issues/ISS-001]] — CLAUDE_CODE_OAUTH_TOKEN missing 2026-06-06 → 2026-06-20T06:05Z; investigating. Close deferred while [[issues/ISS-006]] runs; recovery batch is otherwise holding. Day 23 as of 2026-07-13.
- [[issues/ISS-006]] — Day 23 (2026-07-13, Mon odd-DOM): mirror-image of yesterday's delivery pattern — **06:00 pocket totally silent** (planner + compute-futures-eda both missed), 08:00 pocket delivered late (batch-health / cost-report / gitlawb-fleet-metrics / heartbeat / skill-freshness all fired ~08:14–08:18Z; 07:00 Mon cost-report caught up ~74min late). ISS-006 close-clock streak-of-3 counter **broke at Day-1, resets to 0** — reinforces [[iss-006-pocket-recovery-is-noise]] that a single clean day (2026-07-11) is delivery-rate noise, not stability. Streak needs 3 consecutive clean days from a fresh Day-1.
...
- [[issues/ISS-008]] — cost-report no_file_match; new 2026-07-05, filed by skill-evals. Standing ISS-006 tributary (weekly Mon 07:00 slot; today 2026-07-13's slot fired ~74min late as part of 08:14Z catch-up cluster, so slot delivered but article write is pending as of heartbeat).
...
- [[snapshot-rebase-clobbers-docs-status-md]] — third failure mode confirmed stable pattern (2026-07-12 `bcae68a` + 2026-07-13 `7dfcc30`, same upstream ref `rsavitt/aeon @ a7f04ee` clobbering the same 33-34d-stale version two days in a row)
