...
| vuln-scanner | `articles/vuln-scan-2026-06-20.md` | articles (weekly) | 0h | 192h | ✅ OK |

*All file ages are effectively 0h because this run occurs shortly after git checkout populates the working tree. All thresholds are safely met. Most-recent commit stamped dependency files at 2026-06-21T05:25:18Z (~3h 42m before this run); even by git-commit age all 9 deps clear their thresholds.*
