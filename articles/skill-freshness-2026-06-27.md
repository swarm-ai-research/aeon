...
| vuln-scanner | `articles/vuln-scan-2026-06-20.md` | articles (weekly) | 168h | 192h | ✅ OK |

*All file ages for non-article deps are effectively 0h because this run occurs shortly after git checkout populates the working tree. The vuln-scan article age (168h) is computed from its filename date (2026-06-20); vuln-scanner runs again today (Saturday 2026-06-27) at 16:00 UTC, refreshing this file with 24h to spare before the 192h threshold.*

*Dedup: fingerprint identical to 2026-06-26 run (all-OK set, sha1 da39a3ee); no new flags — notification suppressed (FRESHNESS_NO_CHANGE).*
