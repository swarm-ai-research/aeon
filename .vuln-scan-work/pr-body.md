...
Automated dependency bump to clear disclosed Go ecosystem CVEs surfaced by [osv-scanner](https://google.github.io/osv-scanner/) 2.3.8 at HEAD `8d187f6`.
...
Detected by [osv-scanner](https://google.github.io/osv-scanner/) 2.3.8 against the Go module graph. All advisories listed above are already public via [pkg.go.dev/vuln](https://pkg.go.dev/vuln/list); no private channel needed.
