...
> Auto-generated by `skill-graph` on 2026-06-21. Mode: `SKILL_GRAPH_NEW`.

**Verdict:** SKILL_GRAPH_NEW — 173 skills mapped across 6 categories, 42 enabled
...
```mermaid
flowchart LR
    subgraph research["Research & Content (1 / 20)"]
        research_anchor( )
    end
    ...
    subgraph productivity["Productivity & Meta (15 / 35)"]
        productivity_anchor( )
    end
    subgraph other["Other & Uncategorized (16 / 52)"]
        other_anchor( )
    end
    research_anchor -->|16 edges| productivity_anchor
    other_anchor -->|9 edges| productivity_anchor
    research_anchor -->|8 edges| social_anchor
    dev_anchor -->|4 edges| other_anchor
    other_anchor -->|4 edges| social_anchor
    crypto_anchor -->|3 edges| other_anchor
    other_anchor -->|1 edge| dev_anchor
    productivity_anchor -->|1 edge| dev_anchor
    classDef catbox fill:#fff,stroke:#444,stroke-width:1px
    class research catbox
    class dev catbox
    class crypto catbox
    class social catbox
    class productivity catbox
    class other catbox
```

## Self-healing loop

Aeon's reliability spine — runs autonomously to detect, evaluate, and repair degraded skills. State flows through `memory/cron-state.json`.

```mermaid
flowchart LR
    cron[("memory/cron-state.json")]:::state
    heartbeat[heartbeat ⚡]
    ...
    skill-health -.->|reads/writes| cron
    skill-repair -.->|reads| cron
    cron -.->|on degrade| skill-repair
    cron -.->|"consecutive_failures >= 3"| skill-repair
    cron -.->|"consecutive_failures >= 2"| planner
    classDef state fill:#f9f7e8,stroke:#aaa,stroke-dasharray:3 3,color:#555
...
### Research & Content (1 / 20)

```mermaid
flowchart LR
    subgraph cat_research["Research & Content"]
    ...
    subgraph ext_research["external"]
        rss-feed["rss-feed<br/><small>productivity</small>"]:::external
        syndicate-article["syndicate-article<br/><small>social</small>"]:::external
        update-gallery["update-gallery<br/><small>productivity</small>"]:::external
    end
    article -.-> rss-feed
    article -.-> syndicate-article
    article -.-> update-gallery
    channel-recap -.-> rss-feed
    channel-recap -.-> syndicate-article
    channel-recap -.-> update-gallery
    competitor-launch-radar -.-> rss-feed
    competitor-launch-radar -.-> syndicate-article
    competitor-launch-radar -.-> update-gallery
    deep-research -.-> rss-feed
    deep-research -.-> syndicate-article
    deep-research -.-> update-gallery
    last30 -.-> rss-feed
    last30 -.-> syndicate-article
    last30 -.-> update-gallery
    paper-digest -.-> rss-feed
    paper-digest -.-> syndicate-article
    paper-digest -.-> update-gallery
    research-brief -.-> rss-feed
    research-brief -.-> syndicate-article
    research-brief -.-> update-gallery
    technical-explainer -.-> rss-feed
    technical-explainer -.-> syndicate-article
    technical-explainer -.-> update-gallery
    class agi-tracker enabled
...
flowchart LR
    subgraph cat_dev["Dev & Code"]
        ...
        pr-review["pr-review<br/><small>0 9,18 * * *"  # red…</small>"]
    ...
    subgraph ext_dev["external"]
        contributor-spotlight["contributor-spotlight<br/><small>other</small>"]:::external
        fleet-state["fleet-state<br/><small>other</small>"]:::external
        idea-pipeline["idea-pipeline<br/><small>other</small>"]:::external
        notegraph["notegraph<br/><small>productivity</small>"]:::external
        vuln-tracker["vuln-tracker<br/><small>other</small>"]:::external
    end
    ...
    class autoresearch-goal disabled
...
```mermaid
flowchart LR
    subgraph cat_crypto["Crypto & Markets"]
    ...
    subgraph ext_crypto["external"]
        idea-pipeline["idea-pipeline<br/><small>other</small>"]:::external
        rwa-pulse["rwa-pulse<br/><small>other</small>"]:::external
        topic-momentum["topic-momentum<br/><small>other</small>"]:::external
    end
...
flowchart LR
    ...
    subgraph ext_social["external"]
        ai-framework-watch["ai-framework-watch<br/><small>other</small>"]:::external
        article["article<br/><small>research</small>"]:::external
        channel-recap["channel-recap<br/><small>research</small>"]:::external
        competitor-launch-radar["competitor-launch-radar<br/><small>research</small>"]:::external
        content-engine["content-engine<br/><small>other</small>"]:::external
        deep-research["deep-research<br/><small>research</small>"]:::external
        ecosystem-pulse["ecosystem-pulse<br/><small>other</small>"]:::external
        last30["last30<br/><small>research</small>"]:::external
        paper-digest["paper-digest<br/><small>research</small>"]:::external
        pm-manipulation["pm-manipulation<br/><small>other</small>"]:::external
        research-brief["research-brief<br/><small>research</small>"]:::external
        technical-explainer["technical-explainer<br/><small>research</small>"]:::external
    end
    ai-framework-watch -.-> syndicate-article
    article -.-> syndicate-article
    channel-recap -.-> syndicate-article
    competitor-launch-radar -.-> syndicate-article
    content-engine -.-> syndicate-article
    deep-research -.-> syndicate-article
    ecosystem-pulse -.-> syndicate-article
    last30 -.-> syndicate-article
    paper-digest -.-> syndicate-article
    pm-manipulation -.-> syndicate-article
    research-brief -.-> syndicate-article
    technical-explainer -.-> syndicate-article
...
### Productivity & Meta (15 / 35)

```mermaid
flowchart LR
    subgraph cat_productivity["Productivity & Meta"]
    ...
    subgraph ext_productivity["external"]
        ai-framework-watch["ai-framework-watch<br/><small>other</small>"]:::external
        article["article<br/><small>research</small>"]:::external
        channel-recap["channel-recap<br/><small>research</small>"]:::external
        competitor-launch-radar["competitor-launch-radar<br/><small>research</small>"]:::external
        compute-pulse["compute-pulse<br/><small>other</small>"]:::external
        content-engine["content-engine<br/><small>other</small>"]:::external
        deep-research["deep-research<br/><small>research</small>"]:::external
        ecosystem-pulse["ecosystem-pulse<br/><small>other</small>"]:::external
        last30["last30<br/><small>research</small>"]:::external
        ...
        pm-manipulation["pm-manipulation<br/><small>other</small>"]:::external
        research-brief["research-brief<br/><small>research</small>"]:::external
        stale-content-pr-sweeper["stale-content-pr-sweeper<br/><small>dev</small>"]:::external
        technical-explainer["technical-explainer<br/><small>research</small>"]:::external
    end
    ...
    notegraph -..-> stale-content-pr-sweeper
    ai-framework-watch -.-> rss-feed
    ai-framework-watch -.-> update-gallery
    article -.-> rss-feed
    article -.-> update-gallery
    channel-recap -.-> rss-feed
    channel-recap -.-> update-gallery
    competitor-launch-radar -.-> rss-feed
    competitor-launch-radar -.-> update-gallery
    content-engine -.-> rss-feed
    content-engine -.-> update-gallery
    deep-research -.-> rss-feed
    deep-research -.-> update-gallery
    ecosystem-pulse -.-> rss-feed
    ecosystem-pulse -.-> update-gallery
    last30 -.-> rss-feed
    last30 -.-> update-gallery
    paper-digest -.-> rss-feed
    paper-digest -.-> update-gallery
    pm-manipulation -.-> rss-feed
    pm-manipulation -.-> update-gallery
    research-brief -.-> rss-feed
    research-brief -.-> update-gallery
    technical-explainer -.-> rss-feed
    technical-explainer -.-> update-gallery
    ...
    class programmatic-eda disabled
...
### Other & Uncategorized (16 / 52)

```mermaid
flowchart LR
    subgraph cat_other["Other & Uncategorized"]
    ...
    subgraph ext_other["external"]
        deploy-prototype["deploy-prototype<br/><small>dev</small>"]:::external
        fork-cohort["fork-cohort<br/><small>dev</small>"]:::external
        market-context-refresh["market-context-refresh<br/><small>crypto</small>"]:::external
        rss-feed["rss-feed<br/><small>productivity</small>"]:::external
        runpod-spot-pricing["runpod-spot-pricing<br/><small>productivity</small>"]:::external
        syndicate-article["syndicate-article<br/><small>social</small>"]:::external
        update-gallery["update-gallery<br/><small>productivity</small>"]:::external
        vercel-projects["vercel-projects<br/><small>dev</small>"]:::external
        vuln-scanner["vuln-scanner<br/><small>dev</small>"]:::external
    end
    vuln-tracker --> vuln-scanner
    ...
    launch-radar -..-> idea-pipeline
    launch-radar -..-> idea-validator
    market-context-refresh -..-> idea-pipeline
    market-context-refresh -..-> rwa-pulse
    market-context-refresh -..-> topic-momentum
    ...
    class idea-pipeline disabled
    class idea-validator disabled
    class janitor enabled
    class launch-radar disabled
    class memory-flush enabled
    class memory-structural-dedupe enabled
    class milestone-tracker enabled
    class note-taking disabled
    class planner enabled
    class pm-intel disabled
    class pm-manipulation disabled
    class pm-pulse disabled
    class polymarket disabled
    class pr-tracker enabled
    class pvr-triage-monitor disabled
    class pvr-watchlist disabled
    class repo-revive enabled
    class run-frequency-guard disabled
    class rwa-pulse disabled
    class self-review enabled
    class signal-verdict disabled
    class skill-analytics enabled
    class skill-enabler disabled
    ...
    class tweet-digest disabled
    class vuln-tracker disabled
    class wallet-digest disabled
    class x402-monitor disabled
    classDef enabled fill:#fff,stroke:#000,stroke-width:2px,color:#000
    classDef disabled fill:#f5f5f5,stroke:#bbb,color:#888
    classDef external fill:none,stroke:#bbb,stroke-dasharray:3 3,color:#888
...
| `-.->` | `consume:` in a chain step, or content-pipeline (research → syndication) |
| `-..->` | reactive trigger, or derived shared-state (one skill writes a topic file, another reads it) |

| Node style | Meaning |
|------------|---------|
| **Bold border** | `enabled: true` in `aeon.yml` |
| Faded grey | disabled or `workflow_dispatch`-only |
| Dashed border | ghost node from another category (rendered for context) |

Click any node to jump to its `SKILL.md`. Every skill writes `memory/cron-state.json`; those edges are not drawn (universal noise).

## Summary

| Category | Total | Enabled |
|----------|-------|---------|
| Research & Content | 20 | 1 |
| Dev & Code | 36 | 10 |
| Crypto & Markets | 18 | 0 |
| Social | 12 | 0 |
| Productivity & Meta | 35 | 15 |
| Other & Uncategorized | 52 | 16 |
| **All** | **173** | **42** |
...
| `consume` (chain) | 0 |
| reactive triggers | 2 |
| shared-state (derived) | 28 |
| content-pipeline (derived) | 36 |

---

skills parsed: 173 · depends_on: 5 · consume: 0 · reactive: 2 · shared-state derived: 28 · content-pipeline derived: 36 · enabled: 42/173 · mode: SKILL_GRAPH_NEW
