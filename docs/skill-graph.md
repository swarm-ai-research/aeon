...
> Auto-generated by `skill-graph` on 2026-08-09. Mode: `SKILL_GRAPH_NEW`.
...
flowchart LR
    ...
    subgraph productivity["Productivity & Meta (13 / 31)"]
        productivity_anchor( )
    end
    subgraph other["Other & Uncategorized (21 / 58)"]
        other_anchor( )
    end
    crypto_anchor -->|"3"| other_anchor
    dev_anchor -->|"7"| other_anchor
    other_anchor -->|"3"| dev_anchor
...
flowchart LR
    ...
    fork-first-run-alert -..-> fork-cohort
    fork-first-run-alert -..-> fork-skill-gap
    repo-scanner -..-> external-feature
    ...
    contributor-spotlight -..-> fork-cohort
    contributor-spotlight -..-> fork-first-run-alert
    contributor-spotlight -..-> fork-skill-gap
    deploy-prototype -..-> idea-pipeline
    fork-cohort -..-> contributor-spotlight
    fork-cohort -..-> fleet-state
    fork-first-run-alert -..-> contributor-spotlight
    fork-first-run-alert -..-> fleet-state
    ...
    class changelog,code-health,fleet-control,github-monitor,issue-triage,pr-review,pr-triage,vuln-scanner,workflow-security-audit enabled
    class auto-merge,auto-workflow,autoresearch,create-skill,deploy-prototype,external-feature,fork-cohort,fork-first-run-alert,fork-fleet,fork-skill-gap,github-issues,github-releases,github-trending,project-lens,push-recap,repo-actions,repo-article,repo-pulse,repo-scanner,search-skill,skill-security-scan,smithery-manifest,spawn-instance,star-milestone,vercel-projects disabled
...
flowchart LR
    ...
    class cost-report,goal-tracker,heartbeat,notegraph,reflect,skill-evals,skill-health,skill-repair,skill-update-check,skillpacks,stale-content-pr-sweeper,suggest-edges,weekly-shiplog enabled
    class action-converter,autoresearch-goal,daily-routine,deal-flow,evening-recap,idea-capture,morning-brief,onboard,operator-scorecard,reg-monitor,rss-feed,self-improve,skill-leaderboard,startup-idea,tool-builder,update-gallery,v4-readiness,weekly-review disabled
```

### Other & Uncategorized (21 / 58)
...
flowchart LR
    ...
    fork-first-run-alert["fork-first-run-alert<br/><i>dev</i>"]
    fork-skill-gap["fork-skill-gap<br/><i>dev</i>"]
    ...
    class deploy-prototype,fork-cohort,fork-first-run-alert,fork-skill-gap,market-context-refresh,vercel-projects,vuln-scanner external
```
...
| Crypto & Markets | 18 | 0 |
| Social | 12 | 0 |
| Productivity & Meta | 31 | 13 |
| Other & Uncategorized | 58 | 21 |
| **Total** | **172** | **43** |
...
| `consume` (chains) | 0 |
| `reactive` | 2 |
| `shared_state` (derived) | 36 |

---

_skills parsed: 172 · depends_on: 5 · consume: 0 · reactive: 2 · shared-state derived: 36 · enabled: 43/172 · mode: SKILL_GRAPH_NEW_
