...
> Auto-generated by `skill-graph` on 2026-09-13. Mode: `SKILL_GRAPH_NEW`.
...
flowchart LR
    ...
    subgraph other["Other & Uncategorized (25 / 64)"]
        other_anchor( )
    end
    crypto_anchor -->|"3"| other_anchor
    dev_anchor -->|"4"| other_anchor
    other_anchor -->|"1"| dev_anchor
    other_anchor -->|"6"| productivity_anchor
    other_anchor -->|"3"| social_anchor
    research_anchor -->|"8"| productivity_anchor
    research_anchor -->|"4"| social_anchor
...
flowchart LR
    ...
    rss-feed["rss-feed<br/><i>productivity</i>"]
    syndicate-article["syndicate-article<br/><i>social</i>"]
    update-gallery["update-gallery<br/><i>productivity</i>"]
    ...
    class rss-feed,syndicate-article,update-gallery external
```
...
flowchart LR
    ...
    ai-framework-watch["ai-framework-watch<br/><i>other</i>"]
    content-engine["content-engine<br/><i>other</i>"]
    deep-research["deep-research<br/><i>research</i>"]
    last30["last30<br/><i>research</i>"]
    paper-digest["paper-digest<br/><i>research</i>"]
    pm-manipulation["pm-manipulation<br/><i>other</i>"]
    research-brief["research-brief<br/><i>research</i>"]
    ...
    class ai-framework-watch,content-engine,deep-research,last30,paper-digest,pm-manipulation,research-brief external
```
...
flowchart LR
    ...
    click fleet-runner "../skills/fleet-runner/SKILL.md"
    click fleet-state "../skills/fleet-state/SKILL.md"
...
| `consume` (chains) | 0 |
| `reactive` | 2 |
| `shared_state` (derived) | 21 |
| `content_pipeline` (derived) | 21 |

---

_skills parsed: 175 · depends_on: 5 · consume: 0 · reactive: 2 · shared-state derived: 21 · content-pipeline derived: 21 · enabled: 44/175 · mode: SKILL_GRAPH_NEW_
