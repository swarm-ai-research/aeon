...
.audit-bin/              ← pre-built binaries for workflow-security-audit (zizmor, actionlint) committed so the skill works on sandbox runners where outbound installs may be blocked
scripts/
