...
.audit-bin/              ← pre-built scanner binaries (zizmor, actionlint) committed for offline use in the GHA sandbox; updated when version pins in workflow-security-audit/SKILL.md are bumped
scripts/
